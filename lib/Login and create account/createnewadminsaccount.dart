...
class createadminacc extends StatefulWidget {
  const createadminacc({super.key});

  @override
  State<createadminacc> createState() => _createadminaccState();
}
...
class _createadminaccState extends State<createadminacc> {
  ...
  void submit() async {
    try {
      ...
      final DocumentReference reg = FirebaseFirestore.instance
      ...
      if (reslt.exists) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'User aldready exist,Please login!',
              style: TextStyle(
                color: Colors.white,
              ),
            ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.fromLTRB(8, 0, 0, 0),
                        child: const Text('Department name'),
                      ),
                      Column(
                        children: [
                          Padding(
