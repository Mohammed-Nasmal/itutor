...
//  }
  ...
  //     BuildContext context, String currentUserId, DocumentSnapshot document,int type) {
          ...
          Center(
            child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: Color(0xffff7f7f),
  ...
  static Widget chatText(String chatContent, String id, var listMessage,
    ...
    return Container(
      child: Linkify(
        ...
        text: chatContent,
        style: TextStyle(color: logUserMsg ? Colors.deepPurple : Colors.white),
      ...
      decoration: BoxDecoration(
          color: logUserMsg ? Colors.grey.shade300 : Colors.deepPurple,
